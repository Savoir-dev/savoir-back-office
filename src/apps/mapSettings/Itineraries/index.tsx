...
export const ItinerariesApp = () => {
  const [isCreateItineraryDialogOpen, setIsCreateItineraryDialogOpen] =
    useState(false);

  const onOpenCreateItineraryDialog = () =>
    setIsCreateItineraryDialogOpen(true);
  ...
  return (
    <Flex direction="column" gap="2">
      <Dialog.Root open={isCreateItineraryDialogOpen}>
        ...
        <CreateItineraryModal isTitleField close={onCloseDialog} />
      </Dialog.Root>
      <ItinerariesList />
    </Flex>
  );
